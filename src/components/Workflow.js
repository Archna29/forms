...
<div class="card mb-3 mt-5 ">
  <div class="row g-0">
    <div class="col-md-4">
      <img src={animated} class="img-fluid rounded-start mx-5" alt="..."/>
    </div>
    <div class="col-md-8 mt-5">
      <div class="card-body w-75 mt-5 mx-5">
        <h5 class="card-title w-75 mx-5">An End-To-End Workflow Platform For All Your Business Needs</h5>
        <p class="card-text w-75 mx-5">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
        <button className="btn2 pb-3 pt-3 mx-5 fw-bolder" type="submit" id="review_boloforms">
